...
export default {
  async fetch(request, env) {
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/dingding229/TGChatBot/refs/heads/master/CFTeleTrans/start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/dingding229/TGChatBot/refs/heads/master/CFTeleTrans/notification.md');
